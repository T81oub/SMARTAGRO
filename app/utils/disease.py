diseases = {
   'Apple___Apple_scab': """ <b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        ...
        <br/>4. Apply a 3- to 6-inch layer of compost under the apple trees, ensuring it is kept away from the trunk. This layer will help cover the soil and prevent the splash dispersal of the fungal spores.""", 
